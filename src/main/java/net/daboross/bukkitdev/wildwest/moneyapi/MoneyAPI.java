...
public class MoneyAPI {
	...
	private WildWestBukkit plugin;
	  ...
	  }
	  {
        ...
        if (money != null) {
            money.setExecutor(new Command_Money(plugin));
        }
        if (pay != null) {
            pay.setExecutor(new Command_Pay(plugin));
        }
        WildWestConfiguration config = plugin.getWildWestConfiguration();
        Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, new Task_Interest(plugin),
